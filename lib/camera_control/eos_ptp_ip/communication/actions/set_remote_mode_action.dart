...
class SetRemoteModeAction extends PtpAction<void> {
  SetRemoteModeAction() : super(operationCode: PtpOperationCode.setRemoteMode);
  ...
  FutureOr<void> mapResponse(PtpResponse response) {
    if (response is PtpOperationResponse) {
      logger.info(
          'Received setRemoteMode result: 0x${response.responseCode.toRadixString(16)}');
    }
  }
}
